...
extern "C"
JNIEXPORT void JNICALL
Java_com_app_axe_ffmpagsimple_autovideo_AutoPlayer_release(JNIEnv *env, jobject instance) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_app_axe_ffmpagsimple_autovideo_AutoPlayer_display(JNIEnv *env, jobject instance, jobject surface) {
    if (window) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_app_axe_ffmpagsimple_autovideo_AutoPlayer_play(JNIEnv *env, jobject instance, jstring path_) {
